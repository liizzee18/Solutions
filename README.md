...
E - When the string is recieved, a hashset is created to store the characters of the string.
    The string is then iterated and checked if its contais any of the characters that have been
    seen before in the hashset. 

A - Some anticipated outcomes might be that the given string only has 1 character.
